...
def test_prev_router_loops_back_on_rework(monkeypatch):
    ...
    assert _route_after_prev_audit({"phase_5_verdict": "EXHAUSTED", "phase_5_attempt_count": 1}) == "phase_6_verification"
...
def test_graph_has_loopback_edges():
    ...
    assert ("phase_5_prevention_audit", "phase_6_verification") in edges
