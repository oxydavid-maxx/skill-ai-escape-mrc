...
class CloudPayload(BaseModel):
    """Structured payload returned by the skill-ai-escape-mrc Managed Agent.
    ...
    WIKI-ACTION: trigger_ai_escape_mrc.py validates against this schema BEFORE writing artifacts
    """
    model_config = ConfigDict(strict=True, extra="forbid")
