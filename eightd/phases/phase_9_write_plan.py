...
Replaces both the original subprocess.Popen -> child_runner.py -> superpowers:writing-plans
dispatch that hung in autonomous mode (escape #8, proof 8D run-1777179234), AND
...
8D corrective + prevention actions you receive into a bite-sized-task implementation \
plan in Markdown.
