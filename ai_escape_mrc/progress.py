"""Per-event progress logging for AI Escape MRC runs.
...
**Aggregated human-readable progress** is emitted separately by `ai_escape_mrc.heartbeat`,
which starts a daemon thread at run_ai_escape_mrc.py launch and prints a single-line summary
